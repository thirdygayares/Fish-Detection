...
public final class SimpleTableHeaderAdapter2 extends TableHeaderAdapter {
     ...
     */
    public SimpleTableHeaderAdapter2(final Context context, final String... headers) {
        super(context);
        this.headers = headers;
    }

    public SimpleTableHeaderAdapter2(final Context context, final int... headerStringResources) {
        super(context);
